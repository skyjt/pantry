...
> 最后更新：2026-06-12（v0.5.19：修正 UOS20 glibc 2.28 native 模块打包基线，Linux 包内 better-sqlite3 最高 GLIBC 符号必须 ≤2.28；仍遵守决议 #53，每个增量 commit 必须 patch +1）。**本文描述"当前状态与下一步"，会过期——以 `git log` 与各文档变更记录为准。**

...
> 最后更新：2026-06-12（v0.5.18：沉浸式跨平台修正 #51/#52 + 决议 #53 版本号纪律——`package.json` 版本已补齐为 0.5.18，**此后每个增量 commit 必须 patch +1**，否则 UOS dpkg 同版本拒装）。**本文描述"当前状态与下一步"，会过期——以 `git log` 与各文档变更记录为准。**

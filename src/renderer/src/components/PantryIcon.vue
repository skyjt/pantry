...
<template>
  ...
  >
    ...
    <g v-else-if="name === 'pk'">
      <path d="M5.2 12.8 8.6 9.4c.7-.7 1.9-.7 2.6 0l2.2 2.2-5.9 5.9-2.3-2.3a1.7 1.7 0 0 1 0-2.4Z" />
      <path d="m8.3 9.7-1.2-1.2" />
      <path d="M18.8 12.8 15.4 9.4c-.7-.7-1.9-.7-2.6 0l-2.2 2.2 5.9 5.9 2.3-2.3a1.7 1.7 0 0 0 0-2.4Z" />
      <path d="m15.7 9.7 1.2-1.2" />
      <path d="M10.1 15.1h3.8" />
      <path d="M9 20h6" />
      <path d="M9.7 20v-2.4" />
      <path d="M14.3 20v-2.4" />
    </g>
